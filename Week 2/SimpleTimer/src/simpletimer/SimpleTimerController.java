...
public class SimpleTimerController implements ActionListener {
    ...
    private Logger consol= new Logger();
    
    // Second listener on clock ticks.
   // Listener2 secondConsol = new Listener2();
     ...
     * and Listener2 when the operation phase starts.
     */
    public SimpleTimerController() {
        super();
        ui = new SimpleTimerUI();
        aTimer = new Timer( 250, this);
        Listener2 secondConsol = new Listener2();
        aTimer.addActionListener(secondConsol);
