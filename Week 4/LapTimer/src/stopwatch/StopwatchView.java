...
public class StopwatchView implements Observer {
    ...
    //private StopwatchPanel3 stopwatchPanel;
    ...
    public StopwatchView(StopwatchController controller) {
        ...
        //stopwatchPanel = new StopwatchPanel3(controller);
    ...
    public void setResetState() {
        stopwatchPanel.setButtons(true,false,false,false);
    } 
    ...
    public void setRunningState() {
        stopwatchPanel.setButtons(false,true,false,true);
    } 
    ...
    public void setStoppedState() {
        stopwatchPanel.setButtons(false,false,true, false);
    } 
    
    public void setLapstate(){
        stopwatchPanel.setButtons(false, true, true, true);
    }
